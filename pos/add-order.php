...
if (isset($_GET['payment'])) {
    ...
    try {
        ...
        foreach ($cart as $v) {
            ...
            $insertOrderDetails = mysqli_query($config, "INSERT INTO trans_order_detail(order_id, service_id, qty, price, subtotal) VALUES ($idOrder, $service_id, $qty, $order_price, $subtotal)");
