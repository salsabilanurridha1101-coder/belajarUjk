            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="w-50">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="number" name="percent" value="<?php echo $rowEdit ? $rowEdit['percent'] : '' ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Is Active</label><br>
                        <input type="radio" name="is_active" <?php echo $rowEdit ? $rowEdit == 0 ? 'checked' : '' :'' ?> value="0"> Draf
                        <br>
